...
{
    class Equal : ISampleProvider
    {
        private readonly ISampleProvider sourceProvider; // el soot elly hayesta5demo 
        private readonly EqualizerBand[] bands; // el bands beta3to
        ...
        public Equal(ISampleProvider sourceProvider, EqualizerBand[] bands)
        {
